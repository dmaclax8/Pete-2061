...
intRange= range(0,4,1)  #Format of range() is range(start,stop,increment). 12 is not included in the range
t = list(intRange)
print(t)
type(intRange)
...
# Hyperbolic equation = qi/((1.0+b*di*t)**(1.0/b))
#Harmonic Equation = qi/(1.0+di*t)
...
#Corresponding cumlative productionQ_p= (q_i-q)/D_i
Q_A = [0,0,0,0]
